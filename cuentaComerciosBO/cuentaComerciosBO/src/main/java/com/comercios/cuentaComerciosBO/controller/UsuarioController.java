...
@RestController
@RequestMapping("/api/v1/cuenta-comercios-bo/usuarios")
@SecurityRequirement(name = "Bearer Authentication")
@Tag(name = "Cuenta Comercios BO - Usuarios")
public class UsuarioController {
    ...
    public ResponseEntity<PageableResponseDTO<UsuarioDTO>> buscarTodosPaginado(
        ...
        PageableResponseDTO<UsuarioDTO> usuarios = usuarioService.buscarTodosPaginado(page, size);
